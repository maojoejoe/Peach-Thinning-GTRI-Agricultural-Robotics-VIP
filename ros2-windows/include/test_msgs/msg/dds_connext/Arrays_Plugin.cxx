        ...
        namespace dds_ {
            ...
            * -------------------------------------------------------------------------- */
                ...
                const struct DDS_TypeAllocationParams_t * alloc_params) 
            {
                ...
                sample = new (std::nothrow) Arrays_ ;
                if (sample == NULL) {
                    return NULL;
                }

                if (!test_msgs::msg::dds_::Arrays__initialize_w_params(sample,alloc_params)) {
                    delete  sample;
                    sample=NULL;
                }
                return sample; 
            ...
            Arrays_PluginSupport_create_data_ex(RTIBool allocate_pointers) 
            {
                ...
                if (!test_msgs::msg::dds_::Arrays__initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
                    delete  sample;
                    sample=NULL;
                }
            ...
            {
                return test_msgs::msg::dds_::Arrays_PluginSupport_create_data_ex(RTI_TRUE);
            }
            ...
            Arrays_PluginSupport_destroy_data_w_params(
                ...
                test_msgs::msg::dds_::Arrays__finalize_w_params(sample,dealloc_params);
            ...
            Arrays_PluginSupport_destroy_data_ex(
                ...
                test_msgs::msg::dds_::Arrays__finalize_ex(sample,deallocate_pointers);
            ...
            Arrays_PluginSupport_destroy_data(
                ...
                test_msgs::msg::dds_::Arrays_PluginSupport_destroy_data_ex(sample,RTI_TRUE);
            ...
            Arrays_PluginSupport_copy_data(
                ...
                const Arrays_ *src)
            {
                return test_msgs::msg::dds_::Arrays__copy(dst,(const Arrays_*) src);
            }
            ...
            * ---------------------------------------------------------------------------- */
                ...
                void *containerPluginContext)
            {
                ...
                epd = PRESTypePluginDefaultEndpointData_new(
                    ...
                    test_msgs::msg::dds_::Arrays_PluginSupport_create_data,
                    (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
                    test_msgs::msg::dds_::Arrays_PluginSupport_destroy_data,
                    NULL , NULL );
                ...
                if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
                    serializedSampleMaxSize = test_msgs::msg::dds_::Arrays_Plugin_get_serialized_sample_max_size(
                    ...
                    if (PRESTypePluginDefaultEndpointData_createWriterPool(
                        ...
                        test_msgs::msg::dds_::Arrays_Plugin_get_serialized_sample_max_size, epd,
                        (PRESTypePluginGetSerializedSampleSizeFunction)
                        test_msgs::msg::dds_::Arrays_Plugin_get_serialized_sample_size,
                        epd) == RTI_FALSE) {
                ...
                void *handle)
            {
                ...
                Arrays__finalize_optional_members(sample, RTI_TRUE);
                ...
                const Arrays_ *src)
            {
                ...
                return test_msgs::msg::dds_::Arrays_PluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                try {
                    ...
                    if(deserialize_sample) {
                        ...
                        test_msgs::msg::dds_::Arrays__initialize_ex(sample, RTI_FALSE, RTI_FALSE);
                ...
                const Arrays_ *sample)
            {
                ...
                result = test_msgs::msg::dds_::Arrays_Plugin_serialize(
                ...
                unsigned int length)
            {
                ...
                Arrays__finalize_optional_members(sample, RTI_TRUE);
                return Arrays_Plugin_deserialize_sample( 
                    NULL, sample,
                ...
                const struct DDS_PrintFormatProperty *property)
            {
                ...
                if (!Arrays_Plugin_serialize_to_cdr_buffer(
                    NULL, 
                    &length, 
                    sample)) {
                ...
                void *endpoint_plugin_qos)
            {
                ...
                RTIBool result;
                const char *METHOD_NAME = "Arrays_Plugin_deserialize";
                if (drop_sample) {} /* To avoid warnings */

                stream->_xTypesState.unassignable = RTI_FALSE;
                result= test_msgs::msg::dds_::Arrays_Plugin_deserialize_sample( 
                ...
                unsigned int current_alignment)
            {
                ...
                size = Arrays_Plugin_get_serialized_sample_max_size_ex(
            ...
            * -------------------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if(serialize_key) {
                    ...
                    if (!test_msgs::msg::dds_::Arrays_Plugin_serialize(
                        endpoint_data,
                        sample,
                        stream,
                        RTI_FALSE, encapsulation_id,
            ...
            RTIBool Arrays_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                Arrays_ *sample, 
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
                ...
                void *endpoint_plugin_qos)
            {
                try {
                    ...
                    if (deserialize_key) {
                        ...
                        if (!test_msgs::msg::dds_::Arrays_Plugin_deserialize_sample(
            ...
            RTIBool Arrays_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                Arrays_ **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if (drop_sample) {} /* To avoid warnings */
                stream->_xTypesState.unassignable = RTI_FALSE;
                result= test_msgs::msg::dds_::Arrays_Plugin_deserialize_key_sample(
                ...
                unsigned int current_alignment)
            {
                ...
                current_alignment += test_msgs::msg::dds_::Arrays_Plugin_get_serialized_sample_max_size_ex(
                ...
                unsigned int current_alignment)
            {
                ...
                size = Arrays_Plugin_get_serialized_key_max_size_ex(
                    endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
            ...
            * ------------------------------------------------------------------------ */
            struct PRESTypePlugin *Arrays_Plugin_new(void) 
            { 
                ...
                test_msgs::msg::dds_::Arrays_Plugin_on_participant_attached;
                plugin->onParticipantDetached =
                (PRESTypePluginOnParticipantDetachedCallback)
                test_msgs::msg::dds_::Arrays_Plugin_on_participant_detached;
                plugin->onEndpointAttached =
                (PRESTypePluginOnEndpointAttachedCallback)
                test_msgs::msg::dds_::Arrays_Plugin_on_endpoint_attached;
                plugin->onEndpointDetached =
                (PRESTypePluginOnEndpointDetachedCallback)
                test_msgs::msg::dds_::Arrays_Plugin_on_endpoint_detached;

                plugin->copySampleFnc =
                (PRESTypePluginCopySampleFunction)
                test_msgs::msg::dds_::Arrays_Plugin_copy_sample;
                plugin->createSampleFnc =
                (PRESTypePluginCreateSampleFunction)
                Arrays_Plugin_create_sample;
                plugin->destroySampleFnc =
                (PRESTypePluginDestroySampleFunction)
                Arrays_Plugin_destroy_sample;
                plugin->finalizeOptionalMembersFnc =
                (PRESTypePluginFinalizeOptionalMembersFunction)
                Arrays__finalize_optional_members;

                plugin->serializeFnc =
                (PRESTypePluginSerializeFunction)
                test_msgs::msg::dds_::Arrays_Plugin_serialize;
                plugin->deserializeFnc =
                (PRESTypePluginDeserializeFunction)
                test_msgs::msg::dds_::Arrays_Plugin_deserialize;
                plugin->getSerializedSampleMaxSizeFnc =
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                test_msgs::msg::dds_::Arrays_Plugin_get_serialized_sample_max_size;
                ...
                test_msgs::msg::dds_::Arrays_Plugin_get_key_kind;
                ...
                */
                ...
                plugin->typeCode =  (struct RTICdrTypeCode *)test_msgs::msg::dds_::Arrays__get_typecode();
                ...
                Arrays_Plugin_get_buffer;
                plugin->returnBuffer = 
                (PRESTypePluginReturnBufferFunction)
                Arrays_Plugin_return_buffer;
                plugin->getSerializedSampleSizeFnc =
                (PRESTypePluginGetSerializedSampleSizeFunction)
                test_msgs::msg::dds_::Arrays_Plugin_get_serialized_sample_size;

                plugin->endpointTypeName = Arrays_TYPENAME;

                return plugin;
            }

            void
            Arrays_Plugin_delete(struct PRESTypePlugin *plugin)
            {
