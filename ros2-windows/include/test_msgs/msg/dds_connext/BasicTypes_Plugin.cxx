    ...
    namespace msg {
        namespace dds_ {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                BasicTypes_ *sample = NULL;

                sample = new (std::nothrow) BasicTypes_ ;
                if (sample == NULL) {
                    return NULL;
                }

                if (!test_msgs::msg::dds_::BasicTypes__initialize_w_params(sample,alloc_params)) {
                    delete  sample;
                    sample=NULL;
                }
                return sample; 
            ...
            BasicTypes_PluginSupport_create_data_ex(RTIBool allocate_pointers) 
            {
                ...
                if (!test_msgs::msg::dds_::BasicTypes__initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
                    delete  sample;
                    sample=NULL;
                }
            ...
            {
                return test_msgs::msg::dds_::BasicTypes_PluginSupport_create_data_ex(RTI_TRUE);
            }
            ...
            BasicTypes_PluginSupport_destroy_data_w_params(
                ...
                test_msgs::msg::dds_::BasicTypes__finalize_w_params(sample,dealloc_params);
            ...
            BasicTypes_PluginSupport_destroy_data_ex(
                ...
                test_msgs::msg::dds_::BasicTypes__finalize_ex(sample,deallocate_pointers);
            ...
            BasicTypes_PluginSupport_destroy_data(
                ...
                test_msgs::msg::dds_::BasicTypes_PluginSupport_destroy_data_ex(sample,RTI_TRUE);
            ...
            {
                return test_msgs::msg::dds_::BasicTypes__copy(dst,(const BasicTypes_*) src);
            }
            ...
            * ---------------------------------------------------------------------------- */
                ...
                void *containerPluginContext)
            {
                ...
                epd = PRESTypePluginDefaultEndpointData_new(
                    ...
                    test_msgs::msg::dds_::BasicTypes_PluginSupport_create_data,
                    (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
                    test_msgs::msg::dds_::BasicTypes_PluginSupport_destroy_data,
                    NULL , NULL );
                ...
                if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
                    serializedSampleMaxSize = test_msgs::msg::dds_::BasicTypes_Plugin_get_serialized_sample_max_size(
                    ...
                    if (PRESTypePluginDefaultEndpointData_createWriterPool(
                        ...
                        test_msgs::msg::dds_::BasicTypes_Plugin_get_serialized_sample_max_size, epd,
                        (PRESTypePluginGetSerializedSampleSizeFunction)
                        test_msgs::msg::dds_::BasicTypes_Plugin_get_serialized_sample_size,
                        epd) == RTI_FALSE) {
                ...
                void *handle)
            {
                ...
                BasicTypes__finalize_optional_members(sample, RTI_TRUE);
                ...
                const BasicTypes_ *src)
            {
                ...
                return test_msgs::msg::dds_::BasicTypes_PluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                try {
                    ...
                    if(deserialize_sample) {
                        ...
                        test_msgs::msg::dds_::BasicTypes__initialize_ex(sample, RTI_FALSE, RTI_FALSE);
                ...
                const BasicTypes_ *sample)
            {
                ...
                result = test_msgs::msg::dds_::BasicTypes_Plugin_serialize(
                ...
                unsigned int length)
            {
                ...
                BasicTypes__finalize_optional_members(sample, RTI_TRUE);
                return BasicTypes_Plugin_deserialize_sample( 
                    NULL, sample,
                ...
                const struct DDS_PrintFormatProperty *property)
            {
                ...
                if (!BasicTypes_Plugin_serialize_to_cdr_buffer(
                    NULL, 
                    &length, 
                    sample)) {
                ...
                void *endpoint_plugin_qos)
            {
                ...
                RTIBool result;
                const char *METHOD_NAME = "BasicTypes_Plugin_deserialize";
                if (drop_sample) {} /* To avoid warnings */

                stream->_xTypesState.unassignable = RTI_FALSE;
                result= test_msgs::msg::dds_::BasicTypes_Plugin_deserialize_sample( 
            ...
            RTIBool BasicTypes_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream,   
                ...
                unsigned int current_alignment)
            {
                ...
                size = BasicTypes_Plugin_get_serialized_sample_max_size_ex(
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            RTIBool BasicTypes_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                BasicTypes_ *sample, 
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            RTIBool BasicTypes_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                BasicTypes_ **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if (drop_sample) {} /* To avoid warnings */
                stream->_xTypesState.unassignable = RTI_FALSE;
                result= test_msgs::msg::dds_::BasicTypes_Plugin_deserialize_key_sample(
                ...
                unsigned int current_alignment)
            {
                ...
                size = BasicTypes_Plugin_get_serialized_key_max_size_ex(
                    endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
            ...
            * ------------------------------------------------------------------------ */
            struct PRESTypePlugin *BasicTypes_Plugin_new(void) 
            { 
                ...
                test_msgs::msg::dds_::BasicTypes_Plugin_on_participant_attached;
                plugin->onParticipantDetached =
                (PRESTypePluginOnParticipantDetachedCallback)
                test_msgs::msg::dds_::BasicTypes_Plugin_on_participant_detached;
                plugin->onEndpointAttached =
                (PRESTypePluginOnEndpointAttachedCallback)
                test_msgs::msg::dds_::BasicTypes_Plugin_on_endpoint_attached;
                plugin->onEndpointDetached =
                (PRESTypePluginOnEndpointDetachedCallback)
                test_msgs::msg::dds_::BasicTypes_Plugin_on_endpoint_detached;

                plugin->copySampleFnc =
                (PRESTypePluginCopySampleFunction)
                test_msgs::msg::dds_::BasicTypes_Plugin_copy_sample;
                plugin->createSampleFnc =
                (PRESTypePluginCreateSampleFunction)
                BasicTypes_Plugin_create_sample;
                plugin->destroySampleFnc =
                (PRESTypePluginDestroySampleFunction)
                BasicTypes_Plugin_destroy_sample;
                plugin->finalizeOptionalMembersFnc =
                (PRESTypePluginFinalizeOptionalMembersFunction)
                BasicTypes__finalize_optional_members;

                plugin->serializeFnc =
                (PRESTypePluginSerializeFunction)
                test_msgs::msg::dds_::BasicTypes_Plugin_serialize;
                plugin->deserializeFnc =
                (PRESTypePluginDeserializeFunction)
                test_msgs::msg::dds_::BasicTypes_Plugin_deserialize;
                plugin->getSerializedSampleMaxSizeFnc =
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                test_msgs::msg::dds_::BasicTypes_Plugin_get_serialized_sample_max_size;
                ...
                test_msgs::msg::dds_::BasicTypes_Plugin_get_key_kind;
                ...
                */
                ...
                plugin->typeCode =  (struct RTICdrTypeCode *)test_msgs::msg::dds_::BasicTypes__get_typecode();
                ...
                BasicTypes_Plugin_get_buffer;
                plugin->returnBuffer = 
                (PRESTypePluginReturnBufferFunction)
                BasicTypes_Plugin_return_buffer;
                plugin->getSerializedSampleSizeFnc =
                (PRESTypePluginGetSerializedSampleSizeFunction)
                test_msgs::msg::dds_::BasicTypes_Plugin_get_serialized_sample_size;

                plugin->endpointTypeName = BasicTypes_TYPENAME;

                return plugin;
            }

            void
            BasicTypes_Plugin_delete(struct PRESTypePlugin *plugin)
            {
