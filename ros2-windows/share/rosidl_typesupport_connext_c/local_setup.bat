...
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_typesupport_connext_c] "%AMENT_CURRENT_PREFIX%\share\rosidl_typesupport_connext_c\environment\pythonpath.bat"
