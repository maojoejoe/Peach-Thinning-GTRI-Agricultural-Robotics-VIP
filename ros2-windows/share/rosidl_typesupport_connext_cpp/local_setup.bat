...
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rosidl_typesupport_connext_cpp] "%AMENT_CURRENT_PREFIX%\share\rosidl_typesupport_connext_cpp\environment\pythonpath.bat"
