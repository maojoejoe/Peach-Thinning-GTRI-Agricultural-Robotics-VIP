...
set "AMENT_ENVIRONMENT_HOOKS[rqt_console]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rqt_console] "%AMENT_CURRENT_PREFIX%\share\rqt_console\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rqt_console] "%AMENT_CURRENT_PREFIX%\share\rqt_console\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[rqt_console] "%AMENT_CURRENT_PREFIX%\share\rqt_console\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[rqt_console]:;=";"%") do (
    call:call_file %%f
  )
